...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        texto = calculadora.helloWorld();
        System.out.println(texto);

        // CONCEPTO 2: Cargar un bean dentro de otro bean.

        GestorFacturas gestor = (GestorFacturas) context.getBean("gestorFacturas");
        System.out.println(gestor.calculadora.helloWorld());

        // CONCEPTO 3: scope o alcance
        // los beans por defecto son singleton, se crea el objeto y se utiliza para toda la app
